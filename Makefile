#############################################################################
# Makefile for building: bitcoinex
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun 22. Oct 11:34:33 2017
# Project:  bitcoinex-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile bitcoinex-qt.pro
#############################################################################
...
Makefile: bitcoinex-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile bitcoinex-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/bitcoinex/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/bitcoinex/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/bitcoinex/src/leveldb/libleveldb.a: FORCE
	cd C:/bitcoinex/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-fpermissive -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/bitcoinex/src/leveldb/libleveldb.a && ranlib C:/bitcoinex/src/leveldb/libmemenv.a
