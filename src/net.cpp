...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "bitcoinex " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"35.189.126.61", "35.189.126.61"},
    {"144.217.242.223", "144.217.242.223"},
    {"54.37.14.236", "54.37.14.236"},
    {NULL, NULL}
   };
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. bitcoinex is probably already running."), addrBind.ToString().c_str());
        else
