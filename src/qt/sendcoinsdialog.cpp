    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Bitcoinex address (e.g. BXtwCkgXmtdr5CgyiG8UNk9TB12JKBjoTr)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Bitcoinex address"));
        }
        else
        {
